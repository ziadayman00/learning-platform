...
type Purchase = {
  ...
  course: {
    ...
    _count: {
      reviews: number;
      lessons: number; // Add this
    };
  };
  completedLessons?: number; // Add this
};
...
export default function DashboardClient({
  ...
  const [activeTab, setActiveTab] = useState<"learning" | "teaching">(
    "learning"
  );
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
  {purchases.map((purchase, index) => {
    const totalLessons = purchase.course._count.lessons || 0;
    const completed = purchase.completedLessons || 0;
    const progress = totalLessons > 0 ? (completed / totalLessons) * 100 : 0;

    return (
      <div
        key={purchase.id}
        className="group bg-white rounded-2xl overflow-hidden border-2 border-gray-200 hover:border-black hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
      >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid md:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-2xl p-8 border border-gray-200">
                  ...
                  <div className="text-4xl font-black mb-2">
                    ${instructorStats.totalRevenue.toFixed(0)}
                  </div>
        ...
        <section className="py-20 bg-black text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-400 mb-8">
              Share your expertise with thousands of eager learners and earn
              revenue.
            </p>
            <Button
              size="lg"
